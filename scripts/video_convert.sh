...
codec="libx265"    # использует кодек H.264 для сжатия.(например, libx264)
quality="24"       # уровень качества (чем выше число, тем ниже качество и меньше размер файла). Обычно диапазон 18–28.
